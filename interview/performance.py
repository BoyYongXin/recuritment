...
from sentry_sdk import capture_exception,capture_message #sentry 错误日志异常
...
class PerformanceAndExceptionLoggerMiddleware:
    ...
    def __call__(self, request):
        ...
        # 如果页面出现响应时间较慢，捕获异常
        # if duration > 300:
        #     capture_message("slow request for url :%s with duration: %s"%(request.build_absoult_uri(),duration))
